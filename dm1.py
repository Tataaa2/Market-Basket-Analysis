...
# Judul Aplikasi
st.title("Analisis Market Basket dengan Apriori")# Batasan jumlah baris data yang akan diproses
MAX_ROWS = 1000
...
if uploaded_file is not None:
    try:
        ...
        # Batasi jumlah baris data
        if len(data) > MAX_ROWS:
            st.warning(f"Dataset terlalu besar. Hanya {MAX_ROWS} baris pertama yang akan diproses.")
